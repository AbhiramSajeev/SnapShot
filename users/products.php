...
<html>
<head>
<title>Wowphotos a Ecommerce Category Flat Bootstarp Responsive Website Template | Products :: w3layouts</title>
			...
			<div class="head-nav">
					<span class="menu"> </span>
						<ul class="cl-effect-15">
							...
							<li class="active"><a href="products.php"> Take the tour</a></li>
							<li><a href="register.php">Become a contributor</a></li>
								<div class="clearfix"> </div>
						</ul>
						<!-- script-for-nav -->
					<script>
    		...
    		<div class="section group">
				<div class="col_1_of_4 span_1_of_4">
						<div class="view effect">
					        <a href="single.php">	<img src="images/4.jpg" class="img-responsive" alt=""></a>
					     </div>
							<div class="cart">
								<p class="title"> <a href="single.php">Lorem ipsum dolor</a></p>
								<div class="price">
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="view effect">
				       <a href="single.php"><img src="images/5.jpg" class="img-responsive" alt=""></a>
				     </div>
						<div class="cart">
							<p class="title"> <a href="single.php">Lorem ipsum dolor</a></p>
							<div class="price">
