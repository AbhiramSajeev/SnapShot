...
<h3>ACCEPTED PHOTOGRAPHS</h3>
<?php
$result=mysqli_query($con,"select * from tbl_photograph p,tbl_category c,tbl_subcategory s where p.ca_id=c.ca_id and p.sca_id=s.sca_id and p.status=1");
echo "<table border='3'>";
echo "<tr>";
