...
<h3>REJECTED PAINTING</h3>
<?php
$result=mysqli_query($con,"select * from tbl_painting p,tbl_category c,tbl_subcategory s where p.ca_id=c.ca_id and p.sca_id=s.sca_id and status=2");
echo "<table border='3'>";
echo "<tr>";
