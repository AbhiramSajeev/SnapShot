	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			<div class="header-section">
						...
						<li class="dropdown note">
                       <div class="menu">
								<!--<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-tasks"></i></a>-->
										<ul class="dropdown-menu two">
                                        ...
                                        <li id="menu-academico-boletim" ><a href="customerreport.php"><span style="color:#FBF8F8"> Customer </span></a></li>
										
										<li>
                                        <li id="menu-academico-boletim" ><a href="logout.php"><span style="color:#FBF8F8">Logout </span></a></li>
											<div class="notification_bottom">
