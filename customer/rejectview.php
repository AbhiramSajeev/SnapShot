...
include("header1.php");
?>        
<h3 class="textfont my-lg-4 my-4">Rejected Product</h3>
<div align="center">
<?php
if($utype==3){
$result=mysqli_query($con,"select * from tbl_painting p where p.c_id=$cid and status=2");
echo "<table border='3'>";
echo "<tr>";
...
elseif($utype==2){
$result=mysqli_query($con,"select * from tbl_photograph p where p.c_id=$cid and status=2");
echo "<table border='3'>";
echo "<tr>";
echo "<th>Product Name</th>";
echo "<th>Product</th>";
