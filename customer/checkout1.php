...
?>
                            ...
                            <tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="photoupload/<?php echo $product;  ?>" alt=" " style="height:100px;width:100px;" class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
...
// echo "insert into tbl_delivery(name,mobile,landmark,city,atype,b_id,c_id)values('$name','$mobile','$landmark','$city','$atype',$bid,$cid)";
 mysqli_query($con,"insert into tbl_delivery1(name,mobile,landmark,city,atype,b_id,c_id)values('$name','$mobile','$landmark','$city','$atype',$bid,$cust_id)");
