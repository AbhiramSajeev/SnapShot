						...
						<thead>
							<tr>
								...
								<th>Remove</th>
                                       ...
                                       <?php
                    $result=mysqli_query($con,"select * from tbl_booking2 b inner join tbl_photograph p on p.ph_id=b.ph_id where b.c_id=$cust_id and b.status=0");
...
?>
                           <tbody>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="photoupload/<?php echo $product;  ?>" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
								...
								<td class="invert">
									<div class="rem">
										<a href="deletecheckout1.php?bid=<?php echo $book_id; ?>" class="close1"> </a>
									</div>
				...
				<div class="checkout-left row">
					<div class="col-md-4 checkout-left-basket">
						...
						<ul>
                        <?php 
						$result1=mysqli_query($con,"select * from tbl_photograph where ph_id=$prd_id");
						$row1=mysqli_fetch_array($result1);
						$total=$row1['amount']+50;
						 ?>
							<li><?php echo $row1['ph_name']; ?>
								<i>-</i>
										...
										<div class="card_number_grids">
											<div class="card_number_grid_left">
												<div class="controls">
													...
													<input class="form-control"  pattern="[0-9]{10}" type="text" placeholder="Mobile number" name="mobile">
                                                    <input type="tel" maxlength="10" value="9876543210" required >
												</div>
											</div>
											<div class="card_number_grid_right">
												<div class="controls">
													<label class="control-label">Landmark: </label>
													<input class="form-control" type="text" pattern="^[A-Za_z][A-Za-z -]+$" placeholder="Landmark" name="land" required>
												</div>
											</div>
											<div class="clear"> </div>
										</div>
...
if(isset($_POST["delivery"]))
{
 ...
 $city=$_POST["city"];
 $atype=$_POST["atype"];
  $result2=mysqli_query($con,"select max(b_id) as bid from tbl_booking2 where c_id=$cust_id");
  $row2=mysqli_fetch_array($result2);
  
 $bid=$row2['bid'];
 echo $cus_id=$cust_id;
 mysqli_query($con,"insert into tbl_delivery1(name,mobile,landmark,city,atype,b_id,c_id)values('$name','$mobile','$landmark','$city','$atype',$bid,$cus_id)");
 mysqli_query($con,"update tbl_booking2 set status=1 where b_id=$bid");
