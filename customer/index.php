								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.php?pid=<?php echo $paint_id; ?>" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
...
?>
<?php
                    $result=mysqli_query($con,"select * from tbl_photograph where status=1 and count>0");
while($row=mysqli_fetch_array($result))
{
	$photo=$row['photo'];
	$amount=$row['amount'];
