									...
									<div class="grid images_3_of_2">
										<div class="flexslider1">
												...
												<input type="hidden" name="pid" value="<?php echo $pid; ?>">
													<div class="thumb-image"> <img src="photoupload/<?php echo $photo;  ?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
...
if(isset($_POST["submit"])){
	...
	if($count>=$qty)
	{
	mysqli_query($con,"insert into tbl_booking2(ph_id,c_id,amount,quantity,total,b_date)values($proid,$uid,$amt,$qty,$total,'$bdate')");
